...
ngx_str_t  ngx_http_conf_def_trie_match_longest(u_char *rkey, size_t ksize, u_char *rvalue, ngx_str_t query, size_t* match_len);
ngx_uint_t ngx_http_conf_def_trie_match_path(u_char *rkey, size_t ksize, u_char *rvalue, ngx_str_t query, ngx_array_t* hits);
ngx_uint_t ngx_http_conf_def_trie_match_all(u_char *rkey, size_t ksize, u_char *rvalue, ngx_str_t query, ngx_array_t* hits);
